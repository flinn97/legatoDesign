    ...
    render() {
        ...
        return (
            <div ref={this.wrapperRef} style={this.props.wrapperStyle} className={this.props.wrapperClass}>
                ...
                <div style={{display:'flex', flexDirection:"row", }}>{inputType[this.props.input? this.props.input: "normal"]} <div style={this.props.buttonStyle?this.props.buttonStyle:{marginLeft:"10px", borderRadius:"7px", height:"40px", width:"120px", backgroundColor:"#6C86F4", cursor:"pointer",color:"white", justifyContent:"center", alignItems:"center", display:"flex"}}onClick={this.sub}>{this.props.buttonText? this.props.buttonText: "Add Link"}</div></div>
