       ...
       let app = this.props.app
        return (
            <div className="popup-box to-front">
                <div className="boxdel" ref={this.wrapperRef} style={{marginTop: this.state.marginTop, width:window.innerWidth<600? "95vw":"50vw", height:"40vh"}}>
                        ...
                        <div className="form-group forfiles1" style={{ marginTop: "20px", justifyContent:"space-between", width:"350px" }}>
                            <div >
                                ...
                                onClick={async ()=>{
                                    ...
                                    window.open("https://buy.stripe.com/6oEeVPcCK4XhbNC3cd", "_blank");
