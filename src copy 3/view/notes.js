    ...
    console.log(component);
        return(
            ...
            <div style= {{background:styles.colors.White1, padding:".5vw", borderRadius:".7vw",
              ...
              fontSize: "1.7vmin",}}></div></label>
<ParentFormComponent  type="textArea"   name={"note"} obj={component}>
                        ...
                        <div style= {{display: "flex", flexDirection:"flex-end"}}>
                         <div style= {{...styles.buttons.buttonSubmit, fontSize: "1.7vmin", color:styles.colors.linkVisitedColor}} onClick={this.handleSubmission}>Submit</div>
                     </div>
                 </div>):(<></>)}
                 </>
             )
