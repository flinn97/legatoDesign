...
export default class Register extends Component {
	...
	async handleSubmission()  {
        ...
        debugger
        if(user){
            await this.props.app.state.currentComponent?.getOperationsFactory().componentDispatch({addemail:this.state.email, addspawnerHandle:this.state.spawnerHandle, addfirstName:this.state.firstName, addlastName:this.state.lastName, addbio:this.state.bio, addwebsite:this.state.website, addsocialHandle: this.state.socialHandle, add_id:this.state.email, addowner:this.state.email})
    ...
    <div style={{marginBottom:"2vh",}}>
                        ...
                        <div style={{display:"flex", flexDirection:"column", alignItems:"center", marginTop: styles.margins.marginMediumH}} className="form-group">
                            ...
                            type="text" className="form-control" id="last"   onChange={this.handleChange} name="spawnerHandle"/>
                        </div>
                     ...
                     <div style={{display:"flex", flexDirection:"column",alignItems:"center", marginTop: styles.margins.marginMediumH}} className="form-group">
                        ...
                        <div>
                         ...
                         <div style={{display:"flex", flexDirection:"column",alignItems:"center", marginTop: "4.2vh", cursor:"pointer", textDecoration:"underline 1px #888888"}} onClick={dispatch.bind(this, {registerPage:false})}> Go Back to Login</div>
                     </div>
