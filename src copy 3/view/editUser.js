...
export default class EditUser extends Component {
    ...
    render(){
        ...
        return(
                    <div style={{width:styles.menu.remainderW, height:"105vh", background:styles.colors.Grey2, position:'absolute', zIndex:"700", borderRadius: "2vw"}}>
                    ...
                    alignContent: "center",
                        ...
                        <div style={{marginTop: styles.margins.marginSmallH}} className="form-group">
                            ...
                            <input 
                            style ={{...styles.inputStyle, width:"18vw", }} type="text" className="form-control" id="last" value={this.state.spawnerHandle}  onChange={this.handleChange} name="spawnerHandle"/>
                        </div>
                        <div style={{marginTop: styles.margins.marginSmallH}} className="form-group">
