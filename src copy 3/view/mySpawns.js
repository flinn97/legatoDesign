...
<hr style={{height:"2px", width:"98%", marginBottom:"1vmin", borderRadius:"1vmin", opacity:".52"}}></hr>
      ...
      <div style={{width: styles.mySpawn.keepWidth, marginBottom:"1vh", marginRight:"1vw",  flexWrap: "wrap",}}>
        ...
        {(picture.getJson().owner===app.state.email && !picture.getJson().type.includes("keep") && !picture.getJson().type.includes("user")) &&(
          ...
          <ViewMedia style={{borderRadius: "1vw",}} scale = {0.45} media= {Object.keys(picture.getJson().picURLs).length!==0? Object.values(picture.getJson().picURLs) : [picture.getJson().picURL]}/> </Link>
        </div>
...
{/* THIS IS THE FIRST ROW */}
            <div style={{display:"flex", flexDirection:"row",  justifyContent:"space-between", width: styles.mySpawn.keepWidth,}}>
              ...
              <Link to = {`/${picture.getJson().type}/`+ picture.getJson()._id}  style={{ fontFamily: styles.fonts.fontBold, fontSize: "2.5vh", width: "100%",  flexWrap: "wrap", cursor:"pointer", }} >{picture.getJson().name}</Link>
              </div>
            ...
            <div style={{ fontFamily: styles.fonts.fontNormal,  fontSize: styles.fonts.fontSubheader2,}}>
              ...
              <div style={{ display:"flex", flexDirection:"row", flexWrap: "wrap", fontFamily: styles.fonts.fontNormal, marginBottom:"1vh", fontSize: styles.fonts.fontSubheader3, width: styles.mySpawn.keepWidth,}} >
