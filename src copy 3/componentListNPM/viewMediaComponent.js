...
1: <div style={{cursor:"pointer", display:"flex", flexDirection:"row", justifyContent:"center", borderRadius: "1vw", alignItems:"center"}}>
                ...
                width: (40*s).toString()+"vw", 
                                       height: "fit-content", 
                objectFit: "scale-down", borderRadius: "1vw",
                background: ""}} 
...
2: <div style={{cursor:"pointer", display:"flex", flexDirection:"row", justifyContent:"space-between", alignItems:"center", borderRadius: "1vw"}}>
...
3: <div style={{cursor:"pointer", display:"flex", flexDirection:"row", justifyContent:"space-between", borderRadius: "1vw", alignItems:"center"}}>
                             <div style={{position:"relative",  borderRadius: "1vw", marginRight:".5vmin"}}>
                            {this.props.editable &&<div style={ ///EXIT BUTTON
                            {color: "#A80303", fontWeight:"600", fontSize:"2.5vmin", textShadow:"0px 0px 2px white", width:"fit-content", height:"fit-content", position:"absolute",cursor:"pointer", right:".4vmin", top:".35vmin" , background:"", padding:".3vmin" }
...
4: <div style={{cursor:"pointer", display:"flex", borderRadius: "1vw", flexDirection:"row", alignItems:"center"}}>
...
5: <div style={{cursor:"pointer", display:"flex", borderRadius: "1vw", flexDirection:"column", justifyContent:"space-between", alignItems:"center"}}>
...
6: <div style={{cursor:"pointer", display:"flex", borderRadius: "1vw", flexDirection:"column", justifyContent:"space-between", alignItems:"center"}}>
                                                <div style={{display:"flex", flexDirection:"row",}}>
